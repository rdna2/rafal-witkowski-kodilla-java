...
public class ForumStatistics {
    ...
    public void showStatistics(){
        System.out.println("ForumStatistics Advanced Statistics:");
        ...
        System.out.println("Average Posts  per user" + postsAvgPerUser);
        System.out.println("Average Comments per user" + commentsAvgPerUser);
        System.out.println("Avrage Comments per post" + commentsAvgPerPost);
    }
}